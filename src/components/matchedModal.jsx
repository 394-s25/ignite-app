...
const MatchedModal = ({ person, company, position, skills }) => {
    return (
        <div className="fixed w-full h-full flex justify-center items-center">
            <div className="flex flex-col items-center relative bg-purple-100 w-1/2 h-3/4 rounded-2xl p-2">
                ...
                <header className="mt-12 text-4xl font-bold">You matched!</header>
                ...
                <div className="flex flex-col items-center mt-8">
                    ...
                    <div className="mt-2">
                        {skills.map(skill => (
                            <button key={skill.skillId} className="pl-2 pr-2 mr-1 rounded-2xl bg-purple-400 border-purple-700 border-2 hover:bg-purple-300">
                                {skill.skill}
                            </button>   
                        ))}
                    </div>
                    ...
                    <h3 className="mt-2 font-semibold text-gray-500 cursor-pointer hover:text-gray-700">Unmatch</h3>
                </div>
