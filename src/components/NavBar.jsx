...
const NavBar = () => {
  ...
  const navItems = {
    student: [
      { to: "/studentswipe", label: "Browse Companies" },
      { to: "/studentlikes", label: "Matched Companies" },
    ],
    company: [
      { to: "/companyswipe", label: "Browse Candidates" },
      { to: "/companylikes", label: "Matched Candidates" },
    ],
  };

  const commonItems = [
    { to: "/editProfile", label: "My Profile" },
